                ...
                form.addEventListener(
                    ...
                    function(event) {
                        ...
                        if (!form.checkValidity()) {
                            ...
                            if (!damageReportNumber) {
                                $("#damage_report_number").addClass("is-invalid");
                            }
                            if (!ticketNumber) {
                                $(".select-ticket").addClass("is-invalid");
                            }
                            if (!receiptDate) {
                                $("#damage_report_date").addClass("is-invalid");
                            }
                            if (!actionDate) {
                                $("#action_plan_date").addClass("is-invalid");
                            }
                            if (!scope) {
                            ...
                            $(".repeater-wrapper").each(function(index, wrapper) {
                                let category = $(wrapper).find(".category").val();
                                let location = $(wrapper).find(".location").val();
                                let total = $(wrapper).find(".total").val();

                                if (!category) {
                                    $(wrapper).find(".category").addClass("is-invalid");
                                }
                                if (!location) {
                                    $(wrapper).find(".location").addClass("is-invalid");
                                }
                                if (!total) {
                                    $(wrapper).find(".total").addClass("is-invalid");
                                }
                            });
                        } else {
                            event.preventDefault();
