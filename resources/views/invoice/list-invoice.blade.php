            ...
            columns: [{
                ...
                render: function(data, type, row) {
                    ...
                    if((account.level.id == 1 || account.level.id == 10)){
                        editRow = `<a href="{{ url("invoice/edit")}}/${data}" class="dropdown-item">Edit</a>`;
                    }
