                        ...
                        <div class="col-md-5">
                            <dd class="d-flex justify-content-md-end flex-wrap pe-0 ps-0 ps-sm-2">
                                <div class="mb-3 mx-2">
                                    ...
                                    <input type="text" class="form-control w-px-150 " placeholder="" value="GSI/FIN/IX/23/1629" disabled />
                                </div>
                                <div class="mb-3 mx-2">
        ...
        <div class="col-lg-3 col-12 invoice-actions">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <a href="https://demos.pixinvent.com/vuexy-html-laravel-admin-template/demo-1/app/invoice/preview" class="btn btn-label-secondary d-grid w-100 mb-2">Download</a>
