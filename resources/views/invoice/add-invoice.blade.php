                    ...
                    <div class="repeater">
                        ...
                        <div class="row pb-4">
                            <div class="col-sm-3 px-3">
                                <button type="button" class="btn btn-primary waves-effect waves-light w-px-150" data-repeater-create>Tambah
                                    Baris</button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-3 col-12 invoice-actions">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <a href="{{ route("pages-preview-invoice") }}" class="btn btn-label-secondary d-grid w-100 mb-2">Preview</a>
...
<script>
    $(document).ready(function() {
        $("#tenant").select2({
            allowClear: true,
            ajax: {
                url: "http://127.0.0.1:8000/api/tenant",
                dataType: 'json',
                cache: true,
                data: function(term) {
