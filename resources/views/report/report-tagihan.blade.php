...
@section('content')
    ...
    <div class="card">
        <div class="card-datatable table-responsive pt-0">
            <table class="report-tagihan-table table">
                <thead>
                    <tr>
        ...
        $((function() {
            ...
            if (a.length) var e = a.DataTable({
                ...
                language: {
                    ...
                    search: "",
                    searchPlaceholder: "Search Tagihan"
                },
                buttons: [{
                    text: '<i class="ti ti-plus me-md-1"></i><span class="d-md-inline-block d-none">Buat Tagihan</span>',
            ...
            })), $(".report-tagihan-table tbody").on("click", ".delete-record", (function() {
