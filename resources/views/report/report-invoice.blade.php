...
@section('content')
    ...
    <div class="card">
        <div class="card-datatable table-responsive pt-0">
            <table class="report-invoice-table table">
                <thead>
                    <tr>
        ...
        $((function() {
            ...
            if (a.length) var e = a.DataTable({
                ...
                language: {
                    ...
                    search: "",
                    searchPlaceholder: "Search Report Invoice"
                },
                buttons: [{
                    text: '<i class="ti ti-plus me-md-1"></i><span class="d-md-inline-block d-none">Buat Report Invoice</span>',
            ...
            })), $(".report-invoice-table tbody").on("click", ".delete-record", (function() {
