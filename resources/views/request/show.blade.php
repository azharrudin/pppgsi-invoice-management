                                ...
                                <div class="col-md-5 py-3 px-3">
                                    ...
                                    <div class="col-md-12 pe-none">
                                        <div class="mb-1">
                                            ...
                                            <select class="form-select select2 select-department item-details mb-3" required
                                                readonly>
                                            </select>
                                            <div class="invalid-feedback">Tidak boleh kosong</div>
                                        </div>
                                ...
                                <div class="card academy-content shadow-none border p-3">
                                    ...
                                    <div class="row  text-center mb-5">
                                        <div class="col-3 signatures">
                                            ...
                                            <div class="mb-3">
                                                <input type="text" class="form-control pe-none date"
                                                    placeholder="Tanggal" style="text-align:center;" id="date1"
                                        ...
                                        <div class="col-3 signatures">
                                            ...
                                            <div class="mb-3">
                                                <input type="text" class="form-control pe-none date"
                                                    placeholder="Tanggal" style="text-align:center;" id="date2"
                                                    name="date" required readonly />
                                                <div class="invalid-feedback">Tidak boleh kosong</div>
                                            </div>
                                        </div>
                                        <div class="col-3 signatures">
                                            ...
                                            <div class="mb-3">
                                                <input type="text" class="form-control pe-none date"
                                                    placeholder="Tanggal" style="text-align:center;" id="date3"
                                                    name="date" required readonly />
                                                <div class="invalid-feedback">Tidak boleh kosong</div>
                                            </div>
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function getDataPurchaseRequest() {
                ...
                let response = JSON.parse(localStorage.getItem("purchase-request"));
                $('#addPurchaseRequest').find('.form-control').each(function() {
                    ...
                    if (!response.remaining_budget || !response.proposed_purchase_price || !response
                        .total_budget) {
                        if (elementId === 'total_budget' || elementId === 'proposed_purchase_price' ||
                            elementId === 'remaining_budget') {
                            if (response[elementName] !== null) {
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            $(".select-mr").empty().append('<option value="' + res.data
                                ...
                                '</option>').val(
                                res.data.id);
                            $("#tanggal_mr").val(moment(res.data.request_date, 'YYYY-M-D').format(
                                'DD-MM-YYYY'));
                        },
                        error: function(xhr, status, error) {
                            Swal.fire({
                ...
                for (var i = 0; i < response.details.length; i++) {
                    ...
                    if (i === 0) {
                        ...
                        firstRow.find('#tanggal_rep').val(moment(rowValues.last_buy_date, 'YYYY-MM-DD').format(
                            'D-M-YYYY'));
                ...
                if (response.budget_status != undefined) {
                ...
                for (let i = 1; i < response.signatures.length + 1; i++) {
                    $("#name" + i).val(response.signatures[i - 1].name);
                    ...
                    $('#date' + i).val(moment(response.signatures[i - 1]
