    ...
    <div class="modal-dialog">
        <form class="modal-content create-bank" id="create-bank" novalidate>
            <div class="modal-header">
                <h5 class="modal-title" id="backDropModalTitle">Tambah Departement</h5>
                ...
                if (!form.checkValidity()) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            Swal.fire({
                                title: 'Berhasil',
                                text: 'Berhasil menambahkan Department',
                                icon: 'success',
                                customClass: {
    ...
    function hapusBank(id) {
        ...
        $.ajax({
            ...
            success: function(response, result) {
                Swal.fire({
                    title: 'Berhasil',
                    text: 'Berhasil Hapus Department',
                    icon: 'success',
                    customClass: {
                        confirmButton: 'btn btn-primary'
                    },
