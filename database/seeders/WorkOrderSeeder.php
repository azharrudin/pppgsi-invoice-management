...
class WorkOrderSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $scope = ["Telekomunikasi", "Electric", "Plumbing", "Civil", "BAS", "MDP", "HVAC", "Lift", "Fire System", "GENSET", "Others"];
        $classification = ["Previous Maintenance Routine", "Previous Maintenance Non Routine", "Repair", "Replacement", "Vendor"];
